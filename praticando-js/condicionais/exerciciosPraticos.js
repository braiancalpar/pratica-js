...
if (hora >= 9 && hora < 18 && diaSemana > 0 && diaSemana < 6) {
  console.log("Loja aberta em horário normal");
} else if (hora > 9 && hora <= 14) {
  console.log("Loja aberta em horário especial");
} else {
  console.log("Loja fechada");
}

// Solução sem escolha de horário
// const diaSemana = 6;
...
//operador ternário condition ? se : senao
...
console.log("Status de bateria:", porcentagem);
