...
// No final, exibir valor do contador
...
// executar o laço enquanto não gerar um par
...
const textoTratado = texto.replaceAll(" ", "").toLowerCase();

let textoInvertido = "";

for (let i = textoTratado.length - 1; i >= 0; i--) {
  textoInvertido += textoTratado[i];
}

const result =
  textoTratado === textoInvertido
    ? `${texto} é palíndromo`
